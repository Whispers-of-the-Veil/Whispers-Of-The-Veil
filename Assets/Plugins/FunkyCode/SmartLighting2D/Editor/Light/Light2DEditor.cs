	...
	public class Light2DEditor : Editor
	{
		...
		private bool OnScene_FreeForm()
		{
			...
			for(int i = 0; i < points.Count; i++)
			{
				...
				var fmh_201_52_638756579313631600 = Quaternion.identity; Vector3 result = Handles.FreeMoveHandle(point, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
		...
		private bool OnScene_Point()
		{
			...
			var fmh_255_51_638756579313647070 = Quaternion.identity; Vector3 result = Handles.FreeMoveHandle(point, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
			...
			var fmh_298_61_638756579313649350 = Quaternion.identity; Vector3 innerHandle = Handles.FreeMoveHandle(innerPoint, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
			...
			if (light2D.spotAngleInner < 360)
			{
				...
				var fmh_336_70_638756579313651480 = Quaternion.identity; Vector3 outerHandleLeft = Handles.FreeMoveHandle(outerPointLeft, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
				...
				var fmh_362_72_638756579313653470 = Quaternion.identity; Vector3 outerHandleRight = Handles.FreeMoveHandle(outerPointRight, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
